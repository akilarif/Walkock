...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int act_num = intent_activity.getIntExtra("RecognisedActivity", -2);
    ...
    // Menu options are disabled for this version of this app
    // It may be implemented in the future versions
    /*
    @Override
    ...
    public void onBackPressed() {
    	...
    	Toast.makeText(MainActivity.this, "This app does not exit when back button is pressed!", Toast.LENGTH_SHORT)
    	.show();
    }
